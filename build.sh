...
rpm-ostree install tmux kcm_systemd plymouth-kcm starship solaar solaar-udev neovim libburn cdrskin xorriso ifuse usbmuxd host-spawn kleopatra redshift
